...
To remove an image object from the images array by clicking on it
...
**Outcome:** Standardised all entries to use the same markdown format and added entries that were missing from the log
